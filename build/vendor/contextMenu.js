        ...
        init: function (t, n) {
            ...
            if (!(e(n).length > 0)) {
                ...
                e.each(this.opts.menu, function (t, n) {
                    n.icon ? i += '<li class="ui-context-menu-item"><a href="javascript:void(0);"><img class="icon" src="' + n.icon + '" /><span class="changeName'+t+'">' + n.text + "</span></a></li>" : i += '<li class="ui-context-menu-item"><a href="javascript:void(0);"><span class="changeName'+t+'">' + n.text + "</span></a></li>"
